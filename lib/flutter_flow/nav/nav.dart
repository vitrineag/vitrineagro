      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'VerifyPhoneAuthentication',
              path: 'verifyPhoneAuthentication',
              builder: (context, params) => VerifyPhoneAuthenticationWidget(),
            ),
            FFRoute(
              name: 'IdentifyUser',
              path: 'identifyUser',
            ...
            FFRoute(
              name: 'StartupFavoriteList',
              path: 'startupFavoriteList',
              requireAuth: true,
              builder: (context, params) => StartupFavoriteListWidget(),
            ),
            FFRoute(
              name: 'StartupList',
              path: 'startupList/:startupSite',
  ...
  GoRoute toRoute(AppStateNotifier appStateNotifier) => GoRoute(
        ...
        redirect: (state) {
          ...
          if (requireAuth && !appStateNotifier.loggedIn) {
            ...
            return '/startupList/:startupSite';
          }
          return null;
        },
