...
class _$UserContactRecord extends UserContactRecord {
  ...
  factory _$UserContactRecord(
      ...
      (new UserContactRecordBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'UserContactRecord')
...
class UserContactRecordBuilder
  ...
  @override
  UserContactRecord build() => _build();

  _$UserContactRecord _build() {
    final _$result = _$v ??
